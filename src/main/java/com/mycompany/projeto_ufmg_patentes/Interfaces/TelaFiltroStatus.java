 ...
 * @author MIGUEL
 */
public class TelaFiltroStatus extends javax.swing.JFrame {

    /**
     * Creates new form TelaEmailEnviados
     */
    public TelaFiltroStatus() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tabelaFiltrosPatentes = new javax.swing.JTable();
        ...
        jLabel2.setText("Filtros de Patentes por Status");

        jScrollPane1.setForeground(new java.awt.Color(255, 255, 204));

        tabelaFiltrosPatentes.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        tabelaFiltrosPatentes.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Número Pedido", "Título", "Data", "Autor", "Status"
            }
        ) {
        ...
        tabelaFiltrosPatentes.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                tabelaFiltrosPatentesMouseReleased(evt);
            }
        });
        jScrollPane1.setViewportView(tabelaFiltrosPatentes);
        ...
        jComboBoxCategoria.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Publicação", "Preliminar", "Exame", "Indeferido", "Deferido", " ", " " }));
        ...
        jLabel1.setText("Selecione Patentes pelo Status:");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(btnVoltar4, javax.swing.GroupLayout.PREFERRED_SIZE, 73, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(44, 44, 44)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(207, 207, 207))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addComponent(jComboBoxCategoria, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(279, 279, 279))))
        );
    ...
    private void tabelaFiltrosPatentesMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaFiltrosPatentesMouseReleased
       

        
    }//GEN-LAST:event_tabelaFiltrosPatentesMouseReleased
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaFiltroStatus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaFiltroStatus().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tabelaFiltrosPatentes;
